...
// func NewNotification(recipientUserID uuid.UUID, notificationType NotificationType, message string, senderUserID, relatedEntityID *uuid.UUID) *Notification {
// 	return &Notification{
// 		ID:              uuid.New(),
...
// // IsSystemNotification checks if this is a system notification (no sender)
// func (n *Notification) IsSystemNotification() bool {
// 	return n.SenderUserID == nil
// } 